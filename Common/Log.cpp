...
namespace EgLab::Common
{
    ...
    {
    public:
        Impl(const char* file, size_t line, LogSeverity severity)
        ...
        void output()
        {
            ...
            _stream << '['<< std::setfill('0') << std::setw(2) << hour << ":" << std::setfill('0')<< std::setw(2) << minute << ':' << std::setfill('0')<< std::setw(2) << second 
                ...
                << ']';
#else
            _stream << '[' << std::setfill('0') << std::setw(2) << hour << ":" << std::setfill('0')
                    << std::setw(2) << minute << ':' << std::setfill('0') << std::setw(2) << second
                    << ' ' << _threadId << ']';
#endif
            _stream << " [ " << _fullname << ":" << _line << " ] ";
        }
